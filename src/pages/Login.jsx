...
import { createStellarWallet, encryptAndStoreWallet, getStoredWallet } from '../services/stellar';
...
function Login() {
      ...
      if (authenticated && user) {
        ...
        if (!existingWallet) {
          try {
            ...
            await encryptAndStoreWallet(wallet, user.id);

            await sendWelcomeEmail({
              email: user.email?.address || user.google?.email,
              firstName: user.google?.name?.split(' ')[0] || 'there',
            });
          } catch (error) {
  ...
  useEffect(() => {
    const swiper = new Swiper('.loginart', {
      slidesPerView: 1,
      spaceBetween: 30,
      loop: true,
      pagination: {
    ...
    <section className="main-div">
      <div className="containerr max-lg:h-full grid lg:grid-cols-2 lg:items-center max-lg:py-5 max-lg:min-h-screen">
        <div className="max-lg:flex max-lg:flex-col max-lg:justify-between">
          ...
          <div className="login-menu">
            ...
            <div>
              <form onSubmit={handleSubmit} className="grid gap-y-4 lg:gap-y-6">
                <div className="flex flex-col gap-y-2">
                  ...
                  <input type="text" id="email" name="email" className="form-input" placeholder="Example@email.com" />
                </div>
                <div className="flex flex-col gap-y-2">
                  <label htmlFor="password" className="form-label">Password</label>
                  <input type="password" id="password" name="password" className="form-input" placeholder="At least 8 characters" />
                </div>
                <div className="text-right">
                  <a className="font-normal text-sm leading-full tracking-small text-col-11" href="#">Forgot Password?</a>
                </div>
                <div>
            ...
            <div>
              <div className="text-center middle-border relative">
                <span className="font-normal text-sm leading-8.5 tracking-small text-col-12 mx-auto inline-block">Or</span>
              </div>
          ...
          <div>
            <p className="font-normal text-xs lg:text-sm leading-full tracking-small text-center text-col-5">© 2025 ALL RIGHTS RESERVED</p>
          </div>
        </div>
            ...
            <div className="swiper-wrapper">
              <div className="swiper-slide">
                <div className="loginart-image">
                  <img src="/login-art-1.jpg" alt="login-art-1" />
                </div>
              ...
              <div className="swiper-slide">
                <div className="loginart-image">
                  <img src="/login-art-2.jpg" alt="login-art-2" />
                </div>
                <div className="loginart-text absolute bottom-16 xl:bottom-20 2xl:bottom-46 left-0 2xl:px-23 xl:px-13 z-2 px-8">
