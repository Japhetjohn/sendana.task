            ...
            <ul className="flex items-center gap-x-4 lg:gap-x-5 justify-end">
              ...
              <li className="flex">
                ...
                >
                  ...
                  />
                  <div
                    className={`${showAccountMenu ? 'block' : 'hidden'} absolute right-0 mt-2 w-60 text-left origin-top-right bg-white rounded-lg border border-col-9 z-30 drop-shadow-1`}
                  >
                    <div>
                      ...
                      <button
                        ...
                        className="flex gap-x-3 px-4 py-2.5 font-inter font-normal text-sm leading-5 text-col-5 w-full"
                      >
        ...
        <div className="bg-col-4 p-6 rounded-2xl mb-6 lg:mb-8">
          <div className="flex justify-between gap-x-2 lg:gap-x-4 pb-6 lg:pb-8 border-b border-col-10">
            <div>
              ...
              <h2 className="lg:mb-2.5 mb-1 font-bold text-4xl lg:text-[42.75px] leading-10 lg:leading-12 text-white">
                $0<span className="lg:text-[27.3px] text-2xl leading-8 ml-2 lg:leading-9">.00</span>
              </h2>
          ...
          <div className="pt-6 lg:pt-8">
            <h3 className="font-normal text-sm lg:text-base text-col-12 lg:mb-2.5">
              {stellarWallet ? 'Stellar Wallet Active' : 'No Wallet Connected'}
            </h3>
            {stellarWallet && (
        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-8">
          <div>
            <div className="flex justify-between items-center mb-4">
              <h3 className="font-semibold text-xl leading-[130%] text-col-5">Recent Activity</h3>
              <a href="#" className="font-medium text-base leading-[145%] text-col-4">View All</a>
            </div>
            <div className="border border-col-10 bg-col-13 rounded-2xl">
              <div className="p-6 text-center text-col-8">
          ...
          <div>
            <div className="flex justify-between items-center mb-4">
              <h3 className="font-semibold text-xl leading-[130%] text-col-5">Account Details</h3>
            </div>
            <div className="border border-col-10 bg-col-13 rounded-2xl p-6">
              <div className="space-y-4">
                <div>
                  <p className="text-sm text-col-8">Email</p>
                  <p className="text-base text-col-5 font-medium">{user?.email?.address || 'N/A'}</p>
                </div>
                {stellarWallet && (
                  <div>
                    <p className="text-sm text-col-8">Wallet Status</p>
                    <p className="text-base text-col-5 font-medium">Active</p>
                  </div>
                )}
              </div>
            </div>
